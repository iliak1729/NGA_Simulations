...
echo "Copying Data"
cp ./monitor/Error_Values ./monitor/Error_Values_2D_EllipsoidStress_SpreadSweep
echo "COPY COMPLETE"
...
echo "Copying Data"
cp ./monitor/Error_Values ./monitor/Error_Values_3D_EllipsoidStress_SpreadSweep
echo "COPY COMPLETE"
