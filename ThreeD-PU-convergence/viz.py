...
datafile = "ThreeD-PU-convergence/OLD_SHARE/ProjectedMetricConvergence/Error_Values_2D_ProjectedMetric_MeanCurvatureSweep"
data1 = np.loadtxt(datafile, skiprows=2)
datafile = "ThreeD-PU-convergence/OLD_SHARE/ProjectedMetricConvergence/Error_Values_3D_ProjectedMetric_MeanCurvatureSweep"
...
datafile = "ThreeD-PU-convergence/OLD_SHARE/ProjectedMetricConvergence/Error_Values_2D_ProjectedMetric_MeanCurvatureSweep_Jibben"
data1 = np.loadtxt(datafile, skiprows=2)
datafile = "ThreeD-PU-convergence/OLD_SHARE/ProjectedMetricConvergence/Error_Values_3D_ProjectedMetric_MeanCurvatureSweep_Jibben"
data2 = np.loadtxt(datafile, skiprows=2)
x = data2[:,2]
y = data2[:,3]
refIndex = 1
...
# plt.xlabel('PU Radius, normalized by dx',fontsize=15)
# plt.ylabel('L2 Curvature error',fontsize=20)
